...
const homeSubtitle =
  "A growing collection of UI components and tutorials (soon) — reusable, adaptable, and open to all.";
const paragraph1 =
...
const paragraph3 =
  "Tutorials and guides are on the way. They’ll aim to explain how each piece was built the best I can, to help others follow along and build their own versions.";
...
function Home() {
  ...
  return (
    <section className="w-full text-center px-5 flex flex-col items-center gap-10 my-10 overflow-hidden mask-l-from-80% mask-r-from-80%">
      ...
      <h3 className="text-xl md:px-10 font-medium">
        {(() => {
      ...
      <div className="flex flex-col gap-15 md:px-20">
        ...
        <motion.p
          initial={{ filter: "blur(10px)", opacity: 0, x: -100 }}
          animate={{ filter: "blur(0)", opacity: 1, x: 0 }}
          transition={{ duration: 1, delay: 0.03 * baseIndex + 2.8 }}
          className="text-center font-bold px-10 md:px-30 leading-relaxed"
        >
          {paragraph3}
        </motion.p>
      </div>
