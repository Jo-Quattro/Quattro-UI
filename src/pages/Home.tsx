...
const paragraph2 =
  "I’m still learning — and I probably make mistakes. But this project is open: open to improvements, open to inspiration, and open to anyone whowants to contribute or borrow. If you see something worth enhancing,  feel free to suggest changes or share your own versions. Wherever possible, I credit the original creators who inspired me. Quattro-UI isn’t about reinventing the wheel — it’s about making good ideas more usable, together.";
  ...
  return (
    <section className="w-full text-center px-15 flex flex-col gap-5 my-14">
      ...
      <motion.section
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
        transition={{ duration: 3.5, delay: 0.03 * baseIndex + 0.3 }}
      ...
      <p className=" leading-relaxed mt-4">
        {(() => {
          const output = renderAnimatedText(paragraph1, baseIndex + 45);
          baseIndex = advanceIndex(baseIndex, paragraph1.length);
          return output;
        })()}
      </p>
      ...
      <p className=" leading-relaxed">
        {(() => {
          const output = renderAnimatedText(paragraph2, baseIndex + 5);
          baseIndex = advanceIndex(baseIndex, paragraph2.length);
          return output;
        })()}
      </p>
    </section>
